...
LlamaServerEmbeddingProviderOptions Curation::Scoring::llamaServerEmbeddingOptionsFromConfig()
{
	...
	options.endpoint =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_ENDPOINT), options.endpoint).trimmed();
	options.modelId =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_MODEL_ID), options.modelId).trimmed();
	options.timeoutMs =
		configInt(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_TIMEOUT_MS), options.timeoutMs, 1000, 60000);
	options.maxTextChars =
		configInt(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_MAX_TEXT_CHARS), options.maxTextChars, 500, 24000);
	return options;
}
...
LlamaServerRerankerProviderOptions Curation::Scoring::llamaServerRerankerOptionsFromConfig()
{
	...
	options.endpoint =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_RERANKER_ENDPOINT), options.endpoint).trimmed();
	options.modelId =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_RERANKER_MODEL_ID), options.modelId).trimmed();
	options.timeoutMs =
		configInt(QString::fromLatin1(CONFIG_LOCAL_RERANKER_TIMEOUT_MS), options.timeoutMs, 1000, 120000);
	options.maxTextChars =
		configInt(QString::fromLatin1(CONFIG_LOCAL_RERANKER_MAX_TEXT_CHARS), options.maxTextChars, 500, 24000);
	return options;
}
...
LlamaCppEmbeddingProviderOptions Curation::Scoring::llamaCppEmbeddingOptionsFromConfig()
{
	...
	options.modelPathOrId =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_MODEL_ID), options.modelPathOrId)
			.trimmed();
	options.maxTextChars =
		configInt(QString::fromLatin1(CONFIG_LOCAL_EMBEDDING_MAX_TEXT_CHARS), options.maxTextChars, 500, 24000);
...
LlamaCppRerankerProviderOptions Curation::Scoring::llamaCppRerankerOptionsFromConfig()
{
	...
	options.modelPathOrId =
		PluginConfig::getValue(QString::fromLatin1(CONFIG_LOCAL_RERANKER_MODEL_ID), options.modelPathOrId)
			.trimmed();
	options.maxTextChars =
		configInt(QString::fromLatin1(CONFIG_LOCAL_RERANKER_MAX_TEXT_CHARS), options.maxTextChars, 500, 24000);
