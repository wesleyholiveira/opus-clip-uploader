...
def build_triplets(rows: list[dict[str, Any]], *, min_text_chars: int, max_text_chars: int, max_triplets_per_group: int, transcripts: dict[str, list[dict[str, Any]]] | None = None, profile: str | None = None) -> list[dict[str, Any]]:
